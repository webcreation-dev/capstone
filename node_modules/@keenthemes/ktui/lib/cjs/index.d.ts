...
export type { KTContextMenuConfigInterface, KTContextMenuInterface, } from './components/context-menu';
...
export type { KTPinInputConfigInterface, KTPinInputEventPayloadInterface, KTPinInputInterface, } from './components/pin-input';
export type { KTCarouselConfigInterface, KTCarouselChangePayloadInterface, KTCarouselInterface, } from './components/carousel';
...
export declare const KTComponents: {
    init(): void;
};
declare global {
    interface Window {
