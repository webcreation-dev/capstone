...
var KTSticky = /** @class */ (function (_super) {
    ...
    KTSticky.prototype._debounceScroll = function (callback, delay) {
    ...
    KTSticky.prototype._enable = function () {
        ...
        if (activeClassList) {
            dom_1.default.addClass(this._element, activeClassList);
        }
        else {
        ...
        if (releaseClassList) {
            dom_1.default.removeClass(this._element, releaseClassList);
        }
    ...
    KTSticky.prototype._disable = function () {
        ...
        var activeClassList = this._getOption('activeClass');
        if (activeClassList) {
            dom_1.default.removeClass(this._element, activeClassList);
        }
        else {
            var classList = this._getOption('class');
            if (classList) {
        ...
        var releaseClassList = this._getOption('releaseClass');
        if (releaseClassList) {
            dom_1.default.addClass(this._element, releaseClassList);
        }
        if (this._eventTriggerState === false) {
    ...
    KTSticky.prototype._isRelease = function () {
    ...
    KTSticky.prototype.isRelease = function () {
