...
var KTClipboard = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        if (!hasPredefinedText) return [3 /*break*/, 5];
                        targetElForCut = null;
                        ...
                        if (action === 'cut') {
                            ...
                            targetElForCut = dom_1.default.getElement(targetSelector);
                    ...
                    case 1:
                        _b.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this._writeText(textFromConfig)];
                    case 2:
                        _b.sent();
                    ...
                    case 5:
                        ...
                        targetEl = dom_1.default.getElement(targetSelector);
                        if (!targetEl) {
                            this._setCopiedClass(false);
                            payload = {
                                action: action,
                    ...
                    case 6:
                        _b.trys.push([6, 8, , 9]);
                        return [4 /*yield*/, this._writeText(value)];
                    case 7:
                        _b.sent();
                        this._setCopiedClass(true);
                        if (action === 'cut') {
    ...
    KTClipboard.prototype.dispose = function () {
    ...
    KTClipboard.getInstance = function (element) {
        if (!element)
            return null;
        if (data_1.default.has(element, 'clipboard')) {
            return data_1.default.get(element, 'clipboard');
        }
        return null;
    };
    KTClipboard.getOrCreateInstance = function (element, config) {
        return (this.getInstance(element) || new KTClipboard(element, config !== null && config !== void 0 ? config : undefined));
    };
    KTClipboard.createInstances = function () {
        document.querySelectorAll('[data-kt-clipboard]').forEach(function (el) {
            new KTClipboard(el);
        });
    };
    KTClipboard.init = function () {
        KTClipboard.createInstances();
    };
    return KTClipboard;
}(component_1.default));
exports.KTClipboard = KTClipboard;
