...
var KTModal = /** @class */ (function (_super) {
    ...
    KTModal.prototype._handlers = function () {
        ...
        this._element.addEventListener('click', function (event) {
            ...
            if (_this._getOption('backdropStatic') === false &&
                KTUtils.stringToBoolean(_this._getOption('persistent')) === false) {
                _this._hide();
            }
        });
    };
    ...
    KTModal.handleToggle = function () {
        ...
        KTEventHandler.on(document.documentElement, '[data-kt-modal-toggle]', 'click', function (event, target) {
            event.stopPropagation();
    ...
    KTModal.handleDismiss = function () {
        KTEventHandler.on(document.documentElement, '[data-kt-modal-dismiss]', 'click', function (event, target) {
            event.stopPropagation();
