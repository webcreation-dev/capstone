...
var KTSelectSearch = /** @class */ (function () {
    ...
    KTSelectSearch.prototype._focusSearchInputWithRetry = function (attempt) {
        ...
        var focusAttempt = function () {
            ...
            try {
                ...
                var isFocused = document.activeElement === _this._searchInput ||
                    _this._searchInput === document.activeElement;
                if (isFocused) {
                    // Focus successful
                    return;
                }
            ...
            case 'Enter': {
                ...
                if (optionToSelect) {
                    ...
                    if (optionValue) {
                        ...
                        var isAlreadySelected = !config.multiple &&
    ...
    KTSelectSearch.prototype._filterOptions = function (query) {
        ...
        this._restoreOptionContentsBeforeFilter();
        filterOptions(options, query, config, dropdownElement, function (count) {
