...
var KTSelect = /** @class */ (function (_super) {
    ...
    KTSelect.prototype._showDropdownMessage = function (type, message) {
        ...
        switch (type) {
            case 'error':
                optionsContainer.appendChild(defaultTemplates.error(__assign(__assign({}, this._config), { errorMessage: (_a = message !== null && message !== void 0 ? message : this._config.remoteErrorMessage) !== null && _a !== void 0 ? _a : 'Failed to load data' })));
                break;
            case 'loading':
    ...
    KTSelect.prototype._createHtmlStructure = function () {
        ...
        var dropdownElement = defaultTemplates.dropdown(__assign(__assign({}, this._config), { zindex: (_c = this._config.dropdownZindex) !== null && _c !== void 0 ? _c : undefined }));
    ...
    KTSelect.getInstance = function (element) {
        ...
        if (KTData.has(element, 'select')) {
            return KTData.get(element, 'select');
        }
