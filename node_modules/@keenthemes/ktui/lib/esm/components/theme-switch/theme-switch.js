...
var KTThemeSwitch = /** @class */ (function (_super) {
    ...
    KTThemeSwitch.prototype._handlers = function () {
        ...
        if (!this._element)
            return;
        this._themeSwitchToggleEventId = KTEventHandler.on(document.body, '[data-kt-theme-switch-toggle]', 'click', function () {
            _this._toggle();
        });
        this._themeSwitchSetEventId = KTEventHandler.on(document.body, '[data-kt-theme-switch-set]', 'click', function (event, target) {
    ...
    KTThemeSwitch.prototype.dispose = function () {
        if (this._themeSwitchToggleEventId) {
            KTEventHandler.off(document.body, 'click', this._themeSwitchToggleEventId);
